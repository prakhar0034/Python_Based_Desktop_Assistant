...
def speak(audio): #created a function (speak) using which JARVIS will speak.  
    engine.say(audio)
    engine.runAndWait()


def wishMe():     #JARVIS will wish according to the time
    speak('Jarvis activated')
    hour = int(datetime.datetime.now().hour)
    if hour < 12:
        speak('Good Morning Devansh!')
    elif hour>=12 and hour<17:
        speak("Good Afternoon Devansh!")
    else:
        speak("Good Evening Devansh!")
...
def Weather():
    ...
    if response.status_code == 200:
            try:
                ...
                print(e)
                speak('Devansh there was some problem...')
...
# GREETINGS STARTING ...
        ...
        if 'how are you' in query:
            ...
            msg1 = ['what about you?', 'how are you devansh?']
        ...
        if 'tell about yourself' in query or 'introduce yourself' in query or 'tell something about yourself' in query:
            speak('Hello everyone, I am an Artificial Intelligence, virtual assisstant, I am capable of doing anything. You can call me Jarvis 3 point O... Devansh has created me and I am thankful to him.')
        ...
        if 'who is your god?' in query or 'who is your creator' in query:
            msg3 = ['devansh is my creator, he made me', 'devansh is my god and creator, he made me']
...
# TERMINATING JARVIS #
        if 'exit' in query or 'bye jarvis' in query or 'end working' in query:
            speak("jarvis terminating")
            quit()
